...
('terms', 'title', 'en', 'Terms'),
('terms', 'title', 'sv', 'Villkor'),
('terms', 'close_button', 'en', 'Close and Go Back'),
('terms', 'close_button', 'sv', 'Stäng och Gå Tillbaka'),
...
('pricelist', 'menu_title', 'en', 'Menu'),
('pricelist', 'menu_title', 'sv', 'Meny'),
('pricelist', 'invoices', 'en', 'Invoices'),
('pricelist', 'invoices', 'sv', 'Fakturor'),
('pricelist', 'customers', 'en', 'Customers'),
('pricelist', 'customers', 'sv', 'Kunder'),
('pricelist', 'my_business', 'en', 'My Business'),
('pricelist', 'my_business', 'sv', 'Min Verksamhet'),
('pricelist', 'invoice_journal', 'en', 'Invoice Journal'),
('pricelist', 'invoice_journal', 'sv', 'Fakturajournal'),
('pricelist', 'price_list', 'en', 'Price List'),
('pricelist', 'price_list', 'sv', 'Prislista'),
('pricelist', 'multiple_invoicing', 'en', 'Multiple Invoicing'),
('pricelist', 'multiple_invoicing', 'sv', 'Flera Fakturering'),
('pricelist', 'unpaid_invoices', 'en', 'Unpaid Invoices'),
('pricelist', 'unpaid_invoices', 'sv', 'Obetalda Fakturor'),
('pricelist', 'offer', 'en', 'Offer'),
('pricelist', 'offer', 'sv', 'Erbjudande'),
('pricelist', 'inventory_control', 'en', 'Inventory Control'),
('pricelist', 'inventory_control', 'sv', 'Lagerkontroll'),
('pricelist', 'member_invoicing', 'en', 'Member Invoicing'),
('pricelist', 'member_invoicing', 'sv', 'Medlemsfakturering'),
('pricelist', 'import_export', 'en', 'Import/Export'),
('pricelist', 'import_export', 'sv', 'Import/Export'),
('pricelist', 'log_out', 'en', 'Log out'),
('pricelist', 'log_out', 'sv', 'Logga ut'),
('pricelist', 'search_article', 'en', 'Search Article No...'),
('pricelist', 'search_article', 'sv', 'Sök Artikelnummer...'),
('pricelist', 'search_product', 'en', 'Search Product...'),
('pricelist', 'search_product', 'sv', 'Sök Produkt...'),
('pricelist', 'new_product', 'en', 'New Product'),
('pricelist', 'new_product', 'sv', 'Ny Produkt'),
('pricelist', 'print_list', 'en', 'Print List'),
('pricelist', 'print_list', 'sv', 'Skriv ut Lista'),
('pricelist', 'advanced_mode', 'en', 'Advanced mode'),
('pricelist', 'advanced_mode', 'sv', 'Avancerat läge'),
('pricelist', 'article_no', 'en', 'Article No.'),
('pricelist', 'article_no', 'sv', 'Artikelnummer'),
('pricelist', 'product_service', 'en', 'Product/Service'),
('pricelist', 'product_service', 'sv', 'Produkt/Tjänst'),
('pricelist', 'in_price', 'en', 'In Price'),
('pricelist', 'in_price', 'sv', 'Inpris'),
('pricelist', 'price', 'en', 'Price'),
('pricelist', 'price', 'sv', 'Pris'),
('pricelist', 'unit', 'en', 'Unit'),
('pricelist', 'unit', 'sv', 'Enhet'),
('pricelist', 'in_stock', 'en', 'In Stock'),
('pricelist', 'in_stock', 'sv', 'I Lager'),
('pricelist', 'description', 'en', 'Description'),
('pricelist', 'description', 'sv', 'Beskrivning');

INSERT INTO pricelist_items (article_no, product_service, in_price, price, unit, in_stock, description)
VALUES 
  ('WEB001', 'Website Design Service', 1200.00, 1800.00, 'hours', 50, 'Professional website design and development'),
  ('WEB002', 'Logo Design', 300.00, 450.00, 'pcs', 100, 'Custom logo design package'),
  ('WEB003', 'SEO Optimization', 500.00, 750.00, 'hours', 75, 'Search engine optimization services'),
  ('CONS001', 'Business Consulting', 800.00, 1200.00, 'hours', 40, 'Strategic business consulting'),
  ('CONS002', 'Marketing Strategy', 600.00, 900.00, 'hours', 60, 'Digital marketing strategy development'),
  ('SOFT001', 'Mobile App Development', 2000.00, 3000.00, 'hours', 30, 'iOS and Android app development'),
  ('SOFT002', 'Software Maintenance', 400.00, 600.00, 'hours', 80, 'Monthly software maintenance package'),
  ('SOFT003', 'Database Setup', 700.00, 1050.00, 'pcs', 45, 'Database design and implementation'),
  ('TRAIN001', 'Staff Training', 350.00, 525.00, 'hours', 90, 'Employee training programs'),
  ('TRAIN002', 'Technical Workshop', 450.00, 675.00, 'hours', 55, 'Technical skills workshop'),
  ('DESIGN001', 'Graphic Design', 250.00, 375.00, 'hours', 120, 'Graphic design services'),
  ('DESIGN002', 'UI/UX Design', 550.00, 825.00, 'hours', 65, 'User interface and experience design'),
  ('DESIGN003', 'Print Design', 200.00, 300.00, 'hours', 110, 'Brochure and print material design'),
  ('PHOTO001', 'Product Photography', 400.00, 600.00, 'hours', 70, 'Professional product photography'),
  ('PHOTO002', 'Event Photography', 500.00, 750.00, 'hours', 50, 'Corporate event photography'),
  ('VIDEO001', 'Video Production', 1000.00, 1500.00, 'hours', 35, 'Professional video production'),
  ('VIDEO002', 'Video Editing', 300.00, 450.00, 'hours', 85, 'Video editing and post-production'),
  ('WRITE001', 'Content Writing', 150.00, 225.00, 'hours', 150, 'Professional content writing services'),
  ('WRITE002', 'Copywriting', 200.00, 300.00, 'hours', 130, 'Marketing copywriting'),
  ('TRANS001', 'Translation Services', 180.00, 270.00, 'hours', 95, 'Professional translation services'),
  ('AUDIT001', 'Security Audit', 900.00, 1350.00, 'pcs', 25, 'Comprehensive security audit'),
  ('AUDIT002', 'Code Review', 400.00, 600.00, 'hours', 60, 'Professional code review service');